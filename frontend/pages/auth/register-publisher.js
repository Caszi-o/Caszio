...
import { EyeIcon, EyeSlashIcon, MegaphoneIcon, ChartBarIcon, CurrencyDollarIcon, GlobeAltIcon } from '@heroicons/react/24/outline';
...
export default function RegisterPublisher() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Track performance with comprehensive reporting tools'
    },
    {
      icon: CurrencyDollarIcon,
      title: 'Flexible Budgeting',
      description: 'Set your own budget and pay only for results'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <motion.div className="mt-8 p-6 bg-primary-50 border border-primary-200 rounded-lg" variants={fadeInUp}>
                <h3 className="text-lg font-semibold text-primary-800 mb-2">🚀 Get Started Free!</h3>
                <p className="text-primary-700">
                  No setup fees. Start with a minimum budget of ₹1,000 and scale as you grow.
                </p>
              </motion.div>
            </motion.div>
            ...
            >
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Create Publisher Account</h2>
                <p className="text-gray-600">Join as a publisher to advertise your business</p>
              </div>
